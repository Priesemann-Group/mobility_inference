...
RegressionRightWing <- lm(value ~ `Voted Right Wing (%)`, data = valuetoplotRed)
summary(RegressionRightWing)
AIC(RegressionRightWing)
BIC(RegressionRightWing)
...
RegressionDensRightWing <- lm(value ~ Inhabitantsperkm2 + `Voted Right Wing (%)`, data = valuetoplotRed)
summary(RegressionDensRightWing)
AIC(RegressionDensRightWing)
BIC(RegressionDensRightWing)
...
RegressionDensVoterIncome <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022, data = valuetoplotRed)
summary(RegressionDensVoterIncome)
AIC(RegressionDensVoterIncome)
BIC(RegressionDensVoterIncome)
RegressionDensVoterUnemployment <- lm(value ~ Inhabitantsperkm2 + voterTurnout + unemploymentQuota, data = valuetoplotRed)
summary(RegressionDensVoterUnemployment)
AIC(RegressionDensVoterUnemployment)
BIC(RegressionDensVoterUnemployment)
RegressionDensVoter65 <- lm(value ~ Inhabitantsperkm2 + voterTurnout + peopleover65, data = valuetoplotRed)
summary(RegressionDensVoter65)
AIC(RegressionDensVoter65)
BIC(RegressionDensVoter65)
RegressionDensVoterChildren <- lm(value ~ Inhabitantsperkm2 + voterTurnout + childrenbelow3inprimarycare, data =valuetoplotRed)
summary(RegressionDensVoterChildren)
AIC(RegressionDensVoterChildren)
BIC(RegressionDensVoterChildren)
RegressionDensVoterRight <- lm(value ~ Inhabitantsperkm2 + voterTurnout + `Voted Right Wing (%)`, data = valuetoplotRed)
summary(RegressionDensVoterRight)
AIC(RegressionDensVoterRight)
BIC(RegressionDensVoterRight)
RegressionDensVoterAvgAge <- lm(value ~ Inhabitantsperkm2 + voterTurnout + `Average Age`, data = valuetoplotRed)
summary(RegressionDensVoterAvgAge)
AIC(RegressionDensVoterAvgAge)
BIC(RegressionDensVoterAvgAge)
RegressionDensVoterEmployment <- lm(value ~ Inhabitantsperkm2 + voterTurnout + `Employment Rate`, data = valuetoplotRed)
summary(RegressionDensVoterEmployment)
AIC(RegressionDensVoterEmployment)
BIC(RegressionDensVoterEmployment)

#Income is significant (p<0.01) and increases adj. R^2 by ~ 2%
#4 Variable models
RegressionDensVoterIncomeUnemployment <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + unemploymentQuota, data = valuetoplotRed)
summary(RegressionDensVoterIncomeUnemployment)
AIC(RegressionDensVoterIncomeUnemployment)
BIC(RegressionDensVoterIncomeUnemployment)
RegressionDensVoterIncome65 <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + peopleover65, data = valuetoplotRed)
summary(RegressionDensVoterIncome65)
AIC(RegressionDensVoterIncome65)
BIC(RegressionDensVoterIncome65)
RegressionDensVoterIncomeChildren <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + childrenbelow3inprimarycare, data = valuetoplotRed)
summary(RegressionDensVoterIncomeChildren)
AIC(RegressionDensVoterIncomeChildren)
BIC(RegressionDensVoterIncomeChildren)
RegressionDensVoterIncomeRight <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + `Voted Right Wing (%)` , data = valuetoplotRed)
summary(RegressionDensVoterIncomeRight)
AIC(RegressionDensVoterIncomeRight)
BIC(RegressionDensVoterIncomeRight)
RegressionDensVoterIncomeAvgAge <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + `Average Age`, data = valuetoplotRed)
summary(RegressionDensVoterIncomeAvgAge)
AIC(RegressionDensVoterIncomeAvgAge)
BIC(RegressionDensVoterIncomeAvgAge)
RegressionDensVoterIncomeEmployment <- lm(value ~ Inhabitantsperkm2 + voterTurnout + IncomePerson2022 + `Employment Rate`, data = valuetoplotRed)
summary(RegressionDensVoterIncomeEmployment)
AIC(RegressionDensVoterIncomeEmployment)
BIC(RegressionDensVoterIncomeEmployment)

#Final model RegressionDensVoterIncome
valuetoplotRed <- valuetoplotRed %>% mutate(predicted = predict(RegressionDensVoterIncome))
valuetoplotRed <- valuetoplotRed %>% mutate(predictedManual = summary(RegressionDensVoterIncome)$coeff[1] +
