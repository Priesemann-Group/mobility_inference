...
#Correlation matrix
valuetoplotRed <- valuetoplot %>% ungroup() %>% select(c(value, Inhabitantsperkm2, voterTurnout, IncomePerson2022, unemploymentQuota, peopleover65, childrenbelow3inprimarycare, `Voted Right Wing (%)`, `Average Age`, `Employment Rate`, `Inzidenz_7-Tage`, DifferenceNatmaxLoc))
...
valuetoplotRed <- valuetoplotRed %>% mutate(Inhabitantsperkm2 = scale(Inhabitantsperkm2)) %>%
  ...
  mutate(`Inzidenz_7-Tage` = scale (`Inzidenz_7-Tage`)) %>%
  mutate(DifferenceNatmaxLoc = scale(DifferenceNatmaxLoc))

RegressionDens <- lm(value ~ Inhabitantsperkm2, data = valuetoplotRed)
summary(RegressionDens)
AIC(RegressionDens)
BIC(RegressionDens)
...
Regression65 <- lm(value ~ peopleover65, data = valuetoplotRed)
summary(Regression65)
AIC(Regression65)
BIC(Regression65)
RegressionChildren <- lm(value ~ childrenbelow3inprimarycare, data = valuetoplotRed)
summary(RegressionChildren)
AIC(RegressionChildren)
BIC(RegressionChildren)
RegressionRight <- lm(value ~ `Voted Right Wing (%)`, data = valuetoplotRed)
summary(RegressionRight)
AIC(RegressionRight)
BIC(RegressionRight)
RegressionAvgAge <- lm(value ~ `Average Age`, data = valuetoplotRed)
summary(RegressionAvgAge)
AIC(RegressionAvgAge)
BIC(RegressionAvgAge)
RegressionEmployment <- lm(value ~ `Employment Rate`, data = valuetoplotRed)
summary(RegressionEmployment)
AIC(RegressionEmployment)
BIC(RegressionEmployment)
#RegressionIncidence <- lm(value ~ `Inzidenz_7-Tage`, data = valuetoplotRed)
#summary(RegressionIncidence)

#Models including Income + a second variable
RegressionIncomeDens <- lm(value ~ IncomePerson2022 + Inhabitantsperkm2, data =valuetoplotRed)
summary(RegressionIncomeDens)
AIC(RegressionIncomeDens)
BIC(RegressionIncomeDens)
RegressionIncomeVotes <- lm(value ~ IncomePerson2022 + voterTurnout , data =valuetoplotRed)
summary(RegressionIncomeVotes)
AIC(RegressionIncomeVotes)
BIC(RegressionIncomeVotes)
RegressionIncomeUnemployment <- lm(value ~ IncomePerson2022 + unemploymentQuota , data =valuetoplotRed)
summary(RegressionIncomeUnemployment)
AIC(RegressionIncomeUnemployment)
BIC(RegressionIncomeUnemployment)
RegressionIncome65 <- lm(value ~ IncomePerson2022 + peopleover65 , data =valuetoplotRed)
summary(RegressionIncome65)
AIC(RegressionIncome65)
BIC(RegressionIncome65)
RegressionIncomeChildren <- lm(value ~ IncomePerson2022 + childrenbelow3inprimarycare , data =valuetoplotRed)
summary(RegressionIncomeChildren)
AIC(RegressionIncomeChildren)
BIC(RegressionIncomeChildren)
RegressionIncomeRight <- lm(value ~ IncomePerson2022 + `Voted Right Wing (%)`, data =valuetoplotRed)
summary(RegressionIncomeRight)
AIC(RegressionIncomeRight)
BIC(RegressionIncomeRight)
RegressionIncomeAvgAge <- lm(value ~ IncomePerson2022 + `Average Age`, data =valuetoplotRed)
summary(RegressionIncomeAvgAge)
AIC(RegressionIncomeAvgAge)
BIC(RegressionIncomeAvgAge)
RegressionIncomeEmployment <- lm(value ~ IncomePerson2022 + `Employment Rate`, data =valuetoplotRed)
summary(RegressionIncomeEmployment)
AIC(RegressionIncomeEmployment)
BIC(RegressionIncomeEmployment)
