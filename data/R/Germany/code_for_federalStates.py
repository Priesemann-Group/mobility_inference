...
parser.add_argument("--country", default="Niedersachsen", type=str, help="country to analyze")
parser.add_argument("--name", default="NI", type=str, help="name for this simulation")
...
dir_name = "/Users/sydney/git/mobility_inference/data/R/Germany/R_eff_results/" + tag
...
total_cases_obs = rki.get_total(
    value="confirmed", bundesland=country, data_begin=bd, data_end=ed
)
...
with cov19.model.Cov19Model(**params_model) as this_model:
    ...
    R_eff = pm.Deterministic("R_eff", pm.math.exp(lambda_t_log))
